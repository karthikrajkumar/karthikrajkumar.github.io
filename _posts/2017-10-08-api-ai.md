...
Before we start creating an intent, we shall create an entity. Entity is a place where we can create synonyms for words. Telling the agent how to intepret conversations between people.
